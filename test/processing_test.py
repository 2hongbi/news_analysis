...
data = pd.read_excel("./../data/news1_아프간난민수용보도에찬반뜨거워.xlsx")
...
print("\n준비과정 2 - 한글, 숫자만 가능하도록 댓글 처리(영어, 특수문자 제거하기), 정규식으로 표현")
...
# ++ 추가 ex) '무슬람 정부'를 '무슬람' + '정부'로 쪼개서 담는게 싫다면 Twitter 이용해서 임의로 명사 추가하기!('무슬람 정부'가 한 단어로 취급)
'''
from ckonlpy.tag import Twitter
Twitter = Twitter()
Twitter.add_dictionary('무슬람정부', 'Noun')
Twitter.add_dictionary('무슬람 정부', 'Noun')
'''
